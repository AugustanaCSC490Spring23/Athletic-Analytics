...
for p in range(3):
    ...
    for i in division:
        ...
        if len(conf)==7:
            ...
            conference = " ".join(conf[0:-3])
        confSplit = conference.split()
        if len(conf)>1:
            conference = "_".join(conf)
